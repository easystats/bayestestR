test_that("diagnostic_posterior default", {
  ...
  expect_equal(dp$Rhat, c(1.001218705610197, 0.9997185343161158), tolerance = 1e-3)
  expect_true(is.numeric(dp$ESS))
  expect_true(all(dp$ESS > 0))
  expect_equal(dp$MCSE, c(0.02455353655881737, 0.019981604021430396), tolerance = 1e-3)
