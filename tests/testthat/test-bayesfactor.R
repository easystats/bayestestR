...
test_that("bayesfactor_savagedickey", {
  ...
  bayesfactor_savagedickey <- bayestestR::bayesfactor_savagedickey(Xposterior, prior = Xprior, h0 = 0, direction = 0)
  testthat::expect_equal(as.numeric(bayesfactor_savagedickey), 39.6, tolerance = 0.1)

  bayesfactor_savagedickey <- bayestestR::bayesfactor_savagedickey(Xposterior, prior = Xprior, h0 = 0, direction = 1)
  testthat::expect_equal(as.numeric(bayesfactor_savagedickey), 76.8, tolerance = 0.1)

  bayesfactor_savagedickey <- bayestestR::bayesfactor_savagedickey(Xposterior, prior = Xprior, h0 = 1, direction = 0)
