...
- [`as.matrix(`*`<bayestestRBF>`*`)`](https://easystats.github.io/bayestestR/reference/bayesfactor_methods.md)
  [`update(`*`<bayesfactor_models>`*`)`](https://easystats.github.io/bayestestR/reference/bayesfactor_methods.md)
  [`as.numeric(`*`<bayestestRBF>`*`)`](https://easystats.github.io/bayestestR/reference/bayesfactor_methods.md)
  [`as.logical(`*`<bayesfactor_restricted>`*`)`](https://easystats.github.io/bayestestR/reference/bayesfactor_methods.md)
