# Getting help with {bayestestR}

Thanks for using [bayestestR](https://easystats.github.io/bayestestR/).
...
- If you’re not sure: let’s
  [discuss](https://github.com/easystats/bayestestR/discussions) it and
  try to figure it out! If your problem *is* a bug or a feature request,
  you can easily return here and report it.

Before opening a new issue, be sure to [search issues and pull
requests](https://github.com/easystats/bayestestR/issues) to make sure
