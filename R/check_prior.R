...
#' @param simulate_priors Should prior distributions be simulated using \link[=simulate_prior]{\code{simulate_prior}} (default; faster) or sampled (slower, more accurate).
#' @examples
#' library(bayestestR)
#' library(rstanarm)
#'
