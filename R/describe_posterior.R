...
describe_posterior.default <- function(posterior, ...) {
  insight::format_error(
    paste0(
      "`describe_posterior()` is not yet implemented for objects of class `",
      class(posterior)[1],
      "`."
    )
  )
...
.describe_posterior <- function(
  ...
  if (
    !is.null(centrality) &&
      length(centrality) == 1 &&
      (centrality == "none" || isFALSE(centrality))
  ) {
    centrality <- NULL
  }
...
.add_effects_component_column <- function(x) {
  ...
  if (!"Response" %in% names(x)) {
    x <- cbind(x, data.frame(Response = NA))
  }
  x
}
...
#' @export
describe_posterior.numeric <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
describe_posterior.data.frame <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.bayesQR <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.draws <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.effectsize_std_params <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.get_predicted <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.emmGrid <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
  ...
  if (
    any(c("all", "bf", "bayesfactor", "bayes_factor") %in% tolower(test)) ||
...
#' @export
describe_posterior.slopes <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @rdname describe_posterior
#' @export
describe_posterior.stanreg <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @inheritParams diagnostic_posterior
#' @export
describe_posterior.stanmvreg <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
  ...
  if (isTRUE(priors)) {
    ...
    priors_data$Parameter <- gsub(
      "^(.*)\\|(.*)",
      replacement = "\\2",
      priors_data$Parameter
    )
...
#' @inheritParams diagnostic_posterior
#' @export
describe_posterior.stanfit <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.brmsfit <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.MCMCglmm <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.bcplm <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.bamlss <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
...
#' @export
describe_posterior.BFBayesFactor <- function(
  posterior,
  centrality = "median",
  dispersion = FALSE,
  ci = 0.95,
  ...
  if (priors) {
    ...
    out <- .merge_and_sort(
      out,
      priors_data,
      by = intersect(names(out), names(priors_data)),
      all = TRUE
    )
  }
