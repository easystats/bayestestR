...
#' @param raw If \code{TRUE} (default), the computation is based on the raw ratio of samples superior and inferior to 0. If \code{FALSE}, the result is based on the \link[=auc]{Area under the Curve (AUC)}.
#' @inheritParams hdi
#'
