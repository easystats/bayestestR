...
posterior %>% 
  ...
  annotate("text", x=0.4, y=1, label="The 89% HDI", color="white", size=8) +
  xlab("\nParameter Value") +
  ylab("Probability Density\n")
```
...
- Makowski, D., Ben-Shachar M. S., \& Lüdecke, D. (2019). *Understand and Describe Bayesian Models and Posterior Distributions using bayestestR*. Available from https://github.com/easystats/bayestestR. [DOI:10.5281/zenodo.2556486](https://zenodo.org/badge/latestdoi/165641861).