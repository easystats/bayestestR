...
[**`bayesfactor()`**](https://easystats.github.io/bayestestR/reference/bayesfactor.html) computes the Bayes Factor, *i.e.*, the likelihood ratio between two competing hypotheses.
