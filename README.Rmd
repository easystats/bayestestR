...
[**`bayesfactor()`**](https://easystats.github.io/bayestestR/reference/bayesfactor.html) computes the Bayes Factor between two competing hypotheses.
...
```{r message=FALSE, warning=FALSE, echo=FALSE}
posterior <- rnorm_perfect(1000, mean = 1, sd = 0.7) %>% 
  density() %>% 
  as.data.frame()
...
posterior %>% 
  ...
  geom_segment(x=0, xend=0, y=0, yend=max(prior$y), color="blue", size=1) +
  geom_point(x=0, y=max(prior$y), color="blue", size=5) +
  geom_segment(x=0, xend=0, y=0, yend=density_at(posterior$x,0), color="#E91E63", size=1) +
  geom_point(x=0, y=density_at(posterior$x,0), color="#E91E63", size=5) +
  theme_classic() +
...
[**`rnorm_perfect()`**](https://easystats.github.io/bayestestR/reference/rnorm_perfect.html), [**`rcauchy_perfect()`**](https://easystats.github.io/bayestestR/reference/rnorm_perfect.html), [**`rpois_perfect()`**](https://easystats.github.io/bayestestR/reference/rnorm_perfect.html), [**`rt_perfect()`**](https://easystats.github.io/bayestestR/reference/rnorm_perfect.html): Generate a sample of size n with a near-perfect distributions.
