...
- [Example 1: Linear Models](https://easystats.github.io/bayestestR/articles/example1_LM.html)
- [Example 2: General Linear Models](https://easystats.github.io/bayestestR/articles/example2_GLM.html)
