...
The adoption of the Bayesian framework for applied statistics, especially in social or psychological sciences, seems to be developing in two distinct directions (or "schools"). One of the key topic marking their separation is their opinion about the **Bayes factor**. In short, some authors advocate its use and emphasize its qualities as a statistical index, and others point its limits. 
