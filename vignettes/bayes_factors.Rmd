...
Let's use the Students' (1908) Sleep data set (`sleep`), in which **people took some drug** and where the researchers measured the number of hours of **extra hours of sleep** that they slept after. We will try answering the following question: *given the observed data, how likely it is that the **drug** (the variable `group`) **has no effect** on the numbers of hours of **extra sleep** (variable `extra`)?*
