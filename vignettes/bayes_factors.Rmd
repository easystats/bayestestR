...
## Testing a Model's Parameters with Bayes Factors
...
Let's use the Students' Sleep data set (`sleep`), and try and answer the question: ***given the observed data, is it more or less likely that the drug (the variable `group`) has no effect on the numbers of hours of extra sleep (variable `extra`)?***
