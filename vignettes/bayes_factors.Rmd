...
For example, above we compared $\mathcal{H}_{+}: \theta > 0$ - *the difference is positive*
to the null $\mathcal{H}_{-}: \theta < 0$: *the difference is negative*:
