...
If we set our prior to have a normal distribution centered at 0 hours with a scale (an SD) of 2.5 hours, or prior would look like this:
...
By looking at the posterior distribution, can now compute the posterior probability of the drug's effect falling *within the null-region*, and the posterior probability of the drug's effect falling *outside the null-region* to get out posterior odds:
...
### Comparing Bayesian models (`brms` and `rstanarm`)
...
### Comparing Frequentist models via the BIC approximation 
