...
***Special care should be taken when working with factors which have 3 or more levels.*** This section introduces the biased priors obtained when using the common *effects* factor coding (`contr.sum`), and the solution of using orthogonal factor coding (`contr.bayes`) [as outlined in @rouder2012default, section 7.2].
...
The solution is to use *orthogonal* factor coding, a-la `conrt.bayes`, which can either specify this factor coding per-factor:
