...
This is done by by comparing the density (likelihood) of the null value under the prior between the prior and posterior distributions [@wagenmakers2010bayesian].
...
kable(insight::get_priors(model), digits=3)
```
