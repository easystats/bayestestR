...
As we can see, the parameters take the form of a wide dataframe with two columns, corresponding to the intercept and the effect of `Petal.Length`. These columns contain the **posterior distributions** of these two parameters. In simple terms, the posterior distribution is a set of different plausible values for each parameter.
...
3. And some **indices of significance**, giving information about the relative importance of this effect.
...
ggplot(posteriors, aes(x = Petal.Length)) +
  geom_density(fill = "wheat") +
  # The mean in blue
  geom_vline(xintercept=mean(posteriors$Petal.Length), color="steelblue3", size=1) +
  # The median in red
  geom_vline(xintercept=median(posteriors$Petal.Length), color="tomato3", size=1) +
  # The MAP in purple
