---
title: "Comparison of Indices of Effect Existence"
output: 
  github_document:
    toc: true
    fig_width: 10.08
...
For the sake of time and computational space, we downloaded the data from github. However, you can find the code to generate it **HERE (ADD LINK)** (*takes about 1h*).
...
- ***p*-direction**: the "Probability of Direction" corresponds to the probability that the effect is stricly positive or negative (consistently with the median's sign).
- ***p*-MAP**: the MAP-based *p*-value is related to the odds that a parameter has againt the null hypothesis [@mills2014bayesian; @mills2017objective].
...
- **ROPE (95\%)**: this index refers to the percentage of the 95\% HDI that lies within the Region of Practical Equivalence (ROPE) defined as ranging from -0.1 to 0.1.
