...
rbind(
  rbind(
    ...
    get_data(predictor="bayesfactor_0707", outcome="equivalence_95", lbound=0, ubound=5),
    get_data(predictor="bayesfactor_1", outcome="equivalence_95", lbound=0, ubound=5)
    ) %>% 
  ...
  rbind(
    ...
    get_data(predictor="bayesfactor_0707", outcome="equivalence_90", lbound=0, ubound=5),
    get_data(predictor="bayesfactor_1", outcome="equivalence_90", lbound=0, ubound=5)
    ) %>% 
