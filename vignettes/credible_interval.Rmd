...
(Kruschke, 2014, p. 183ff).

However, 95\% has some [**advantages too**](https://easystats.github.io/blog/posts/bayestestr_95/). For instance, it shares (in some cases) an intuitive relationship with the standard deviation and it conveys a more accurate image of the (artificial) bounds of the distribution. Also, because it is wider, it makes analyses more conservative (i.e., the probability of covering 0 is larger for 95\% CI than for lower ranges such as 89\%), which is a good thing.

Ultimately, **you as the user should decide**, based on your needs and goals, and justify your decision.
