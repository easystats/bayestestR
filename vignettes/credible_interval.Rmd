...
to be more stable than, for instance, 95\% intervals [@kruschke2014doing],
typically having a smaller Monte Carlo standard error (MCSE)
and a higher effective sample size (ESS; see [here](https://easystats.github.io/bayestestR/reference/diagnostic_posterior.html))
than 95% intervals.
