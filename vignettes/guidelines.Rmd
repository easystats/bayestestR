...
<!-- Removed BF for now because of frontiers paper reasons ;)  -->

<!-- - "the effect of *X* has a probability of ***pd*** of being *negative* (Median = ***median***, 89\% CI [ ***HDI<sub>low</sub>*** , ***HDI<sub>high</sub>*** ], *BF*<sub>10</sub> = ***BF***, indicating that the data is ... times more probable under the alternative) and can be considered as *significant* (***ROPE***\% in ROPE)." -->
...
<!-- I actually really like this paragraph, but it needs some reorganization of this vignette.  -->
