...
knitr::include_graphics("https://cdn.shopify.com/s/files/1/0940/1604/files/IMG_8910_grande.JPG")
```
...
**That's it!** You fitted a Bayesian version of the model by simply using [`stan_glm()`](https://mc-stan.org/rstanarm/reference/stan_glm.html) instead of `lm()`. The conclusion that we can drawn, in this, are very similar. The median effect is about `0.41`, and it can be also be considered as *significant* in the Bayesian sense.

**So, ready to learn more?** Check out the next tutorial **[ADD LINK]**!
