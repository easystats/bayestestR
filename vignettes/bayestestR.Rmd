...
The Bayesian framework for statistics is quickly gaining in popularity among scientists, associated with the general shift towards **open and honest science**. Reasons to prefer this approach are [@andrews2013prior; @etz2016bayesian; @kruschke2010believe; @kruschke2012time; @wagenmakers2018bayesian]:

- **reliability**
- **accuracy** (in noisy data and small samples)
- the possibility of introducing **prior knowledge** into the analysis
- critically, **intuitive nature of results** and their **straightforward interpretation** 
