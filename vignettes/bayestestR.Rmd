...
distribution of the effect. For example, we can report the median, the [95% Credible Interval](https://easystats.github.io/bayestestR/articles/credible_interval.html)
