...
read.csv("https://raw.github.com/easystats/circus/master/data/bayesSim_study1.csv") %>% 
  ...
  geom_segment(aes(x=0.95, y=Inf, xend=0.95, yend=0.1), color="black", linetype="longdash") +
  geom_segment(aes(x=-Inf, y=0.1, xend=0.95, yend=0.1), color="black", linetype="longdash") +
  theme_modern() +
  scale_y_reverse(breaks = round(seq(0, 1, length.out = 11), digits=2)) +
  scale_x_continuous(breaks = round(c(0.95, seq(0.5, 1, length.out = 6)), 2)) +
