...
It *seems* (visually) that *virgnica* flowers have, on average, a slightly higher
...
From the indices, we can say that the difference of `Sepal.Width` between *virginica* and *versicolor* has a probability of **100% of being negative** [*from the pd and the sign of the median*] (median = -0.19, 95% CI [-0.31, -0.07]). The data provides a **strong evidence against the null hypothesis** (BF = 18).
